...
module.exports = {
  ...
  int64: function (ctx) {
    return read_value(ctx, 'getInt64', 8, true);
  },
  uint64: function (ctx) {
    return read_value(ctx, 'getUint64', 8, true);
  },
  leint64: function (ctx) {
    return read_value(ctx, 'getInt64', 8, true);
  },
  leuint64: function (ctx) {
    return read_value(ctx, 'getUint64', 8, true);
  },
  beint64: function (ctx) {
    return read_value(ctx, 'getInt64', 8, false);
  },
  beuint64: function (ctx) {
    return read_value(ctx, 'getUint64', 8, false);
  },
