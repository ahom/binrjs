...
var string = function* (encoding, byte_size, length, little_endian) {
  length = length || 0;
  var bytes = null;
  if (length) {
...
module.exports = {
  ...
  string8: function* (length) {
    return this.read_with_args(string)('utf-8', 1, length, true);
  },

  lestring16: function* (length) {
    return this.read_with_args(string)('utf-16le', 2, length, true);
  },

  bestring16: function* (length) {
    return this.read_with_args(string)('utf-16be', 2, length, false);
  }
};
